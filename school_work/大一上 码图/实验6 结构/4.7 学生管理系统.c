...
int main() {
  ...
  for (i = 0; i < student_num; i++) {
    scanf("%s %d %d %f %d %d", &information[i].name, &information[i].gender,
          &information[i].birthday, &information[i].height,
          &information[i].C_score, &information[i].math_score);
  ...
  for (i = 0; i < student_num; i++) {
    if (information[i].C_score == C_max) {
      printf("%s %d %d %.2f %d %d\n", information[i].name,
             information[i].gender, information[i].birthday,
             information[i].height, information[i].C_score,
             information[i].math_score);
    }
  }
  printf("C_min:%d\n", C_min);
